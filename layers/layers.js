...
lyr_TradaJosngelGmezLuna_2.set('fieldAliases', {'Lonxitude': 'Lonxitude', 'Titular': 'Titular', 'Imaxe': 'Imaxe', });
lyr_TradaIsmaelLorenzoGndara_3.set('fieldAliases', {'Lonxitude': 'Lonxitude', 'Titular': 'Titular', 'Imaxe': 'Imaxe', });
lyr_Tubocamisa160mm_4.set('fieldAliases', {'Nome': 'Nome', 'Lonxitude': 'Lonxitude', });
lyr_Arquetasrexistro_5.set('fieldAliases', {'Nome': 'Nome', 'X': 'X', 'Y': 'Y', 'Imaxe': 'Imaxe', });
lyr_Arquetagranderexistro_6.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'Nome': 'Nome', 'Imagen': 'Imagen', });
lyr_Mangueiraxeral_7.set('fieldAliases', {'Nome': 'Nome', 'Lonxitude': 'Lonxitude', 'Imaxe': 'Imaxe', });
lyr_Navedepsitos_8.set('fieldAliases', {'Nome': 'Nome', 'X': 'X', 'Y': 'Y', 'imaxe': 'imaxe', });
lyr_Manantial_9.set('fieldAliases', {'Nome': 'Nome', 'X': 'X', 'Y': 'Y', 'imagen': 'imagen', });
lyr_TradaRicardoLorenzoGndara_1.set('fieldImages', {'Lonxitude': 'TextEdit', 'Titular': 'TextEdit', });
lyr_TradaJosngelGmezLuna_2.set('fieldImages', {'Lonxitude': 'TextEdit', 'Titular': 'TextEdit', 'Imaxe': 'ExternalResource', });
lyr_TradaIsmaelLorenzoGndara_3.set('fieldImages', {'Lonxitude': 'TextEdit', 'Titular': 'TextEdit', 'Imaxe': 'ExternalResource', });
lyr_Tubocamisa160mm_4.set('fieldImages', {'Nome': 'TextEdit', 'Lonxitude': 'Range', });
lyr_Arquetasrexistro_5.set('fieldImages', {'Nome': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'Imaxe': 'ExternalResource', });
lyr_Arquetagranderexistro_6.set('fieldImages', {'X': 'TextEdit', 'Y': 'TextEdit', 'Nome': 'TextEdit', 'Imagen': 'ExternalResource', });
lyr_Mangueiraxeral_7.set('fieldImages', {'Nome': 'TextEdit', 'Lonxitude': 'Range', 'Imaxe': 'ExternalResource', });
lyr_Navedepsitos_8.set('fieldImages', {'Nome': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'imaxe': 'ExternalResource', });
lyr_Manantial_9.set('fieldImages', {'Nome': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'imagen': 'ExternalResource', });
...
lyr_TradaJosngelGmezLuna_2.set('fieldLabels', {'Lonxitude': 'inline label - always visible', 'Titular': 'inline label - always visible', 'Imaxe': 'inline label - always visible', });
lyr_TradaIsmaelLorenzoGndara_3.set('fieldLabels', {'Lonxitude': 'inline label - always visible', 'Titular': 'inline label - always visible', 'Imaxe': 'inline label - always visible', });
lyr_Tubocamisa160mm_4.set('fieldLabels', {'Nome': 'inline label - always visible', 'Lonxitude': 'inline label - always visible', });
lyr_Arquetasrexistro_5.set('fieldLabels', {'Nome': 'inline label - always visible', 'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'Imaxe': 'inline label - always visible', });
lyr_Arquetagranderexistro_6.set('fieldLabels', {'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'Nome': 'inline label - always visible', 'Imagen': 'inline label - always visible', });
lyr_Mangueiraxeral_7.set('fieldLabels', {'Nome': 'inline label - visible with data', 'Lonxitude': 'inline label - always visible', 'Imaxe': 'inline label - always visible', });
lyr_Navedepsitos_8.set('fieldLabels', {'Nome': 'inline label - visible with data', 'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'imaxe': 'inline label - always visible', });
lyr_Manantial_9.set('fieldLabels', {'Nome': 'inline label - always visible', 'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'imagen': 'inline label - always visible', });
